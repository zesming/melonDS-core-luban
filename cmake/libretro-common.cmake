...
target_include_directories(libretro-common PRIVATE ${PROJECT_SOURCE_DIR}/src/libretro)
...
# Title metadata downloads use libretro-common's HTTP client independently of
# melonDS Wi-Fi emulation and its optional libslirp dependency.
target_sources(libretro-common PRIVATE
...
if (HAVE_OPENGL)
    ...
    target_include_directories(libretro-common SYSTEM PUBLIC ${OPENGL_INCLUDE_DIR})
endif ()

if (HAVE_OPENGLES2)
    target_sources(libretro-common PRIVATE ${libretro-common_SOURCE_DIR}/glsym/glsym_es2.c)
    target_include_directories(libretro-common SYSTEM PUBLIC ${OpenGLES_V2_INCLUDE_DIR})
endif ()
...
if (HAVE_OPENGLES31)
    target_include_directories(libretro-common SYSTEM PUBLIC ${OpenGLES_V31_INCLUDE_DIR})
elseif (HAVE_OPENGLES32)
    target_include_directories(libretro-common SYSTEM PUBLIC ${OpenGLES_V32_INCLUDE_DIR})
elseif (HAVE_OPENGLES3)
    target_include_directories(libretro-common SYSTEM PUBLIC ${OpenGLES_V3_INCLUDE_DIR})
endif()
